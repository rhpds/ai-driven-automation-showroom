...
image::bastion.png[bastion, 150%, link="bastion.png", window="_blank"]
...
image::bastion2.png[AAP,150%, link="bastion2.png", window="_blank"]

image::workflow_job_1.png[Workflow 1, 150%, link="workflow_job_1.png", window="_blank"]

Step 4: Review the `Create Playbook AI` job-template 

image::workflow_job_2.png[Workflow 1, 150%, link="workflow_job_2.png", window="_blank"]

You can click on the icon and glean from the output the proposed playbook created by Ansible Lighspeed AI.

image::workflow_job_3.png[Workflow 1, 150%, link="workflow_job_3.png", window="_blank"]
...
image::lightspeed_gitea.png[Lightspeed Gitea, 160%, link="lightspeed_gitea.png", window="_blank"]
...
image::workflow-playbook-check.png[Playbook Checkmode, 160%, link="workflow-playbook-check.png", window="_blank"]
...
image::workflow-changed1.png[Change 160%, link="workflow-changed1.png", window="_blank"]
...
image::workflow-changed2.png[Change 2,160%, link="workflow-changed2.png", window="_blank"]
...
image::routing_dashboard1.png[Routing, 160%, link="routing_dashboard1.png", window="_blank"]

image::routing_dash_down.png[Splunk Dashboard, 260%, link="routing_dash_down.png", window="_blank"]
...
image::workflow-approve.png[Approve 160%, link="workflow-approve.png", window="_blank"]

image::approve.png[Approval, 160%, link="approve.png", window="_blank"]

Step 9: Review the `Playbook-Run-Mode` job-template in the workflow.

image::workflow-run.png[Playbook run, 160%, link="workflow-run.png", window="_blank"]
...
image::workflow-changed2.png[Change 260%, link="workflow-changed2.png", window="_blank"]
...
image::routing_dashboard2.png[Routing Dash, 160%, link="routing_dashboard2.png", window="_blank"]
...
image::bastion.png[bastion, 160%, link="bastion.png", window="_blank"]
...
image::workflow_job_1.png[Workflow 1, 160%, link="workflow_job_1.png", window="_blank"]

Step 4: Review the `Create Playbook AI` job-template 

image::workflow_job_2.png[Workflow 1, 160%, link="workflow_job_2.png", window="_blank"]

You can click on the icon and glean from the output the proposed playbook created by Ansible Lighspeed AI.
[quote]
Click here in AAP to review the playbook

image::display_2.png[Display, 160%, link="display_2.png", window="_blank"]

image::workflow_job_5.png[Workflow 4, 160%, link="workflow_job_5.png", window="_blank"]
...
image::workflow-changed4.png[Change 1,160%, link="workflow-changed4.png", window="_blank"]

The following data output displays the when the playbook is run again in `run mode` it would `Change` the configuration by applying the following CLI configuration. 

image::workflow-changed3.png[Change 2,160%, link="workflow-changed3.png", window="_blank"]
...
image::routing_dash_down.png[Splunk Dashboard, 160%, link="routing_dash_down.png", window="_blank"]

Step 8: Human Review
The **Network-AIOps-Workflow** Should be in a paused state until we approve, deny or cancel. If your workflow has succeeded thus far, it's okay to approve the workflow, at this time.

image::workflow-approve.png[Approve 3,160%, link="workflow-approve.png", window="_blank"]
...
image::workflow-changed4.png[Change 3,160%, link="workflow-changed4.png", window="_blank"]
...
image::workflow-changed5.png[Change 1,160%, link="workflow-changed5.png", window="_blank"]

The following data output displays the when the playbook is run again in `run mode` it would `Change` the configuration by applying the following CLI configuration. 

image::workflow-changed6.png[Change 2,160%, link="workflow-changed6.png", window="_blank"]
...
image::workflow-changed5.png[Change 3,160%, link="workflow-changed5.png", window="_blank"]

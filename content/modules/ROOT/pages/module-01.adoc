...
You have successfully completed the core AIOps workflow! You've experienced firsthand how **Red Hat AI**, **Ansible Lightspeed**, and **Ansible Automation Platform** can work together to create intelligent, self-healing infrastructure.
...
== Ready for More? Welcome to Part 2!

image::splunk-logo.png[splunk,150]

If you're interested in exploring how these same AI-driven automation concepts apply to **network automation**, continue to Part 2!
...
[NOTE]
====
**Part 2 is optional.** If you'd like to skip to the Summary and Call to Actions, you can navigate there directly from the menu.
====

== Complete

Click the link below to continue to **Module 3: Splunk** and begin Part 2, or skip ahead to the Summary.

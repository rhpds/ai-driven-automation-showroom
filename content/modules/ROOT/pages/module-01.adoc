...
image::remediation_workflow.png[remediation_workflow, link="_images/remediation_workflow.png", window="_blank"]
...
image::automation_execution_templates.png[automation_execution_templates, link="_images/automation_execution_templates.png", window="_blank"]

[start=3]
3. Navigate to the Templates page and select the *Remediation Workflow* Workflow job template

image::remediation_workflow_list.png[create_workflow, link="_images/remediation_workflow_list.png", window="_blank"]
...
image::view_workflow_visualizer_button.png[visualizer_button,300, link="_images/view_workflow_visualizer_button.png", window="_blank"]

[start=5]
5. Verify you have a window that looks like this:

image::currently_no_nodes_workflow.png[currently_no_nodes_workflow,400, link="_images/currently_no_nodes_workflow.png", window="_blank"]
...
image::add_step_lightspeed_remediation.png[add_step_lightspeed_remediation,500, link="_images/add_step_lightspeed_remediation.png", window="_blank"]

[start=8]
8. Click on the blue *Next*.

image::blue_next_button.png[blue_next_button,150, link="_images/blue_next_button.png", window="_blank"]

[start=9]
9. Review and click the blue *Finish* button.

image::blue_finish_button.png[blue_finish_button,150, link="_images/blue_finish_button.png", window="_blank"]

Your workflow will now look like this:

image::remediation_workflow_part_one.png[remediation_workflow_part_one,500, link="_images/remediation_workflow_part_one.png", window="_blank"]
...
image::workflow_add_step_and_link.png[workflow_add_step_and_link,200, link="_images/workflow_add_step_and_link.png", window="_blank"]
...
image::remediation_workflow_part_two.png[remediation_workflow_part_two,500, link="_images/remediation_workflow_part_two.png", window="_blank"]
...
image::remediation_workflow_part_two_final.png[remediation_workflow_part_two_final,500, link="_images/remediation_workflow_part_two_final.png", window="_blank"]
...
image::remediation_workflow_part_three.png[remediation_workflow_part_three,500, link="_images/remediation_workflow_part_three.png", window="_blank"]
...
image::remediation_workflow_part_three_final.png[remediation_workflow_part_three_final,500, link="_images/remediation_workflow_part_three_final.png", window="_blank"]
...
image::remediation_workflow_part_four.png[remediation_workflow_part_four,500, link="_images/remediation_workflow_part_four.png", window="_blank"]
...
image::remediation_workflow_part_four_final.png[remediation_workflow_part_four_final,500, link="_images/remediation_workflow_part_four_final.png", window="_blank"]
...
image::save_button.png[save_button,150, link="_images/save_button.png", window="_blank"]
...
image::launch_template_button.png[launch_template_button,150, link="_images/launch_template_button.png", window="_blank"]
...
image::workflow_prompt.png[workflow_prompt, link="_images/workflow_prompt.png", window="_blank"]
...
image::remediation_workflow_success.png[remediation_workflow_success,150, link="_images/remediation_workflow_success.png", window="_blank"]
...
image::limit_node1.png[limit_node1,300, link="_images/limit_node1.png", window="_blank"]
...
image::aiops-cool.gif[aiops-cool, link="_images/aiops-cool.gif", window="_blank"]
...
image::splunk-logo.png[splunk,150, link="_images/splunk-logo.png", window="_blank"]

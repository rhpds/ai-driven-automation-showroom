...
image::enrichment_workflow_diagram.png[Enrichment and Prompt Generation Workflow, link="_images/enrichment_workflow_diagram.png", window="_blank"]
...
image::create_workflow.png[create_workflow,300, link="_images/create_workflow.png", window="_blank"]
...
image::create_workflow_job_template.png[create_workflow_job_template,300, link="_images/create_workflow_job_template.png", window="_blank"]
...
image::add_apache_status_check_step.png[Add Apache Status Check Step, link="_images/add_apache_status_check_step.png", window="_blank"]
...
image::workflow_after_apache_status_node.png[Workflow after Apache node, link="_images/workflow_after_apache_status_node.png", window="_blank"]
...
image::add_rhel_ai_step.png[Add RHEL AI Step, link="_images/add_rhel_ai_step.png", window="_blank"]

[start=13]
13. Click Next, then Finish.

image::blue_next_button.png[link="_images/blue_next_button.png", window="_blank"]
image::blue_finish_button.png[link="_images/blue_finish_button.png", window="_blank"]

[start=14]
14. Workflow with two nodes:

image::workflow_after_rhel_ai_step.png[After RHEL AI step, link="_images/workflow_after_rhel_ai_step.png", window="_blank"]
...
image::add_mattermost_step.png[Add Mattermost Step, link="_images/add_mattermost_step.png", window="_blank"]

[start=18]
18. Click Next, then Finish.

image::workflow_after_mattermost_step.png[After Mattermost step, link="_images/workflow_after_mattermost_step.png", window="_blank"]
...
image::add_lightspeed_jt_creator.png[Add Lightspeed JT Creator Step, link="_images/add_lightspeed_jt_creator.png", window="_blank"]
...
image::workflow_final_prompt_generation.png[Final Workflow, link="_images/workflow_final_prompt_generation.png", window="_blank"]

[start=24]
24. Click Save to finalize.

image::save_button.png[link="_images/save_button.png", window="_blank"]
...
image::run_break_apache.png[link="_images/run_break_apache.png", window="_blank"]
...
image::eda_trigger_capture.png[link="_images/eda_trigger_capture.png", window="_blank"]

[start=27]
27. Go to Automation Controller → Jobs. Confirm workflow execution. When the workflow completes you will see a green ✅ Success.

image::workflow_triggered_jobs.png[link="_images/workflow_triggered_jobs.png", window="_blank"]

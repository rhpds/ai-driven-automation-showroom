...
This workshop consists of two independent parts:

- *Part 1: AIOps with Apache Remediation* - 30-40 minutes
- *Part 2: Network Automation* - 50-60 minutes
- *Total Workshop Time* - 80-100 minutes

For this workshop are there 4 Parts:
...
|===
a|image::aap_logo.png[aap_logo,120, link="_images/aap_logo.png", window=blank]
a|

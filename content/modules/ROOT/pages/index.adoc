...
image::aiops.png[aiops,55%,55%, link="_images/aiops.png", window="_blank"]
...
image::aiops-circle.png[aiops diagram,55%,55%, link="_images/aiops-circle.png", window="_blank"]
...
image::more.png[give me more,400, link="_images/more.png", window="_blank"]
...
image::lab_topo.png[Lab Topology,150%,150%, link="_images/lab_topo.png", window="_blank"]

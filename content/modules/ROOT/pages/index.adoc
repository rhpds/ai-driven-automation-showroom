...
[NOTE]
====
**Looking for more?** After completing the core lab (Modules 1-3), there's an optional Part 2 that applies these same AI-driven automation concepts to **network automation**. Details below!
====

== Part 2: AI Driven Ansible for Network Automation (Optional)

image::splunk-logo.png[splunk,150]

Once you've completed the core AIOps workflow with Apache remediation, you can continue your journey by applying the same AI-driven principles to **network automation**.

This optional section synthesizes the 🧠 AI skills from the preceding modules into a practical network automation scenario. You will leverage AI to generate Ansible playbooks designed to troubleshoot **OSPF routing issues** on Cisco routers.
...
Start here! Build your first AI-driven self-healing workflow.

**Part 2: Network Automation** (Modules 4-6)

_Optional:_ Apply the same concepts to OSPF troubleshooting on Cisco routers.
|===

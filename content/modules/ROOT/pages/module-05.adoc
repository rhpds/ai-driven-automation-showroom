...
image::thumbs-up.gif[thumbsup!, link="_images/thumbs-up.gif", window="_blank"]
...
image::eda_response.png[eda response,500, link="_images/eda_response.png", window="_blank"]
...
image::enrichment_workflow_diagram.png[enrichment_workflow, link="_images/enrichment_workflow_diagram.png", window="_blank"]
...
image::remediation_workflow.png[remedation_workflow, link="_images/remediation_workflow.png", window="_blank"]
...
image::eda.png[EDA, 150%, link="_images/eda.png", window="_blank"]
...
image::ansible-aiops.jpeg[picture of homer,300, link="_images/ansible-aiops.jpeg", window="_blank"]
...
image::aap_logo.png[aap_logo,55%,55%, link="_images/aap_logo.png", window="_blank"]

...
image::bastion2.png[AAP, link="bastion2.png", window="_blank"]
...
image::rulebook_validate.png[rulebook validate, 150%, link="rulebook_validate.png", window="_blank"]
...
image::rulebook_history.png[history, 100%, link="rulebook_history.png", window="_blank"]

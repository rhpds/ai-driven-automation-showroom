...
image::bastion2.png[AAP, link="_images/bastion2.png", window="_blank"]
...
image::rulebook_validate.png[rulebook validate, 150%, link="_images/rulebook_validate.png", window="_blank"]
...
[quote]
💡 **Tip:** You can also view the complete rulebook source code in the GitHub repository at https://github.com/ansible-tmm/aiops-summitlab/blob/main/rulebooks/ospf.yml[github.com/ansible-tmm/aiops-summitlab/rulebooks/ospf.yml,window=_blank]. All playbooks and rulebooks used in this lab are available there.
...
image::rulebook_history.png[history, 100%, link="_images/rulebook_history.png", window="_blank"]
